...
save_solution = True
Wsol_filename = "W_sol_GYNI"+str(d)+"D"
TAsol_filename = "TA_sol_GYNI"+str(d)+"D"
TBsol_filename = "TB_sol_GYNI"+str(d)+"D"
...
def see_saw_step(num_iter):
    ...
    for _ in range(num_iter):
        Ws = see_sawW(BW, TAs, TBs, n, d)
        TAs = see_sawT(B, Ws, TBs, 'TA', ns, d)
        TBs = see_sawT(B, Ws, TAs, 'TB', ns, d)


    GY = GYNI_expr(TAs, TBs, 'W')
    obj_val = Ws.T @ GY
...
print("Optimzing GYNI inequality for boxworld processes of dim", d)
